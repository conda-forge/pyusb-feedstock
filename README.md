...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/pyusb-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=7359&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/pyusb-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `pyusb` can be installed with:

```
conda install pyusb
```

It is possible to list all of the versions of `pyusb` available on your platform with:
